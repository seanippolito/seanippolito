      ...
      >
        <svg width="22" height="22" viewBox="0 0 22 22">
          ...
          <g filter="url(#nugget-glow)">
            ...
            {/* Main nugget — irregular rounded shape */}
            <path
